...
listen testmirth
        ...
        bind *:8443
        # bind *:5000-10005
        server mirthnlb internal-tha-mirth-test-internal-elb-1907708468.us-east-1.elb.amazonaws.com check port 8080 resolvers awsresolver
